...
This sequence didn't fully resolve owing to a duplicate sequence in the chromosome. Two possibilities: both the chromosome and the plasmid contain the same duplicated element (a Tn6290 transposon) but remain separate replicons, or the plasmid has integrated into the chromosome, flanked by copies of the duplication. 
...
A path containing the plasmid contigs and Tn6290 transposon was extracted for subsequent analysis.
...
The plasmid-specific portion, with a single integrated copy of Tn6290, goes from position `6501702..6515328` and `1..279596`, as identified by ACT. Extract this sequence, and append with a 'p' to indicate plasmid-specific portion.

...
Note that the suffix 'R' indicates 'resequenced', 'd' indicates 'draft' (i.e. some manual editing necessary to generate the final sequence, as described above), and 'p' indicates the plasmid-specific portion of a (potentially) chromosomally-integrated assembly.

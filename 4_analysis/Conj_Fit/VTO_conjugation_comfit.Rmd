...
Hybrid_data.csv consists of several datasets collected on different dates. **As Nov_23 yields unusual counts compared with other datasets,therefore we chose to exclude.** <-- ??
...
# ggsave("Hybrid_paper_.png",dpi=300,width=7.2,height=8)

ggsave("Hybrid_paper_.png",dpi=1200,width=15,height=10)
